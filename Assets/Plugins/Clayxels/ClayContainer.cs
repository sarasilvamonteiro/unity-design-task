	...
	public class ClayContainer : MonoBehaviour{
		...
		*/
		...
		/*!\brief How many solids can stay one next to another while occupying the same voxel.
			...
			See ClayxelPrefs.cs */
		public void setMaxSolidsPerVoxel(int num){ // public static void setMaxSolidsPerVoxel(int num)
			if(!ClayContainer.prefsOverridden){
				ClayContainer.prefsOverridden = true;
				ClayContainer.applyPrefs();
			}
		...
		*/
		...
		public Mesh generateMesh(int detail, bool colorizeMesh = false, bool computeNormals = false, float smoothNormalAngle = 100.0f, bool freeMemory = false){ /////////////////////////////////// generates mesh at runtime /////////////////////////////////////
			...
			for(int chunkIt = 0; chunkIt < this.numChunks; ++chunkIt){
				...
				int numTris = this.getBufferCount(ClayContainer.meshIndicesBuffer); ///////////////// change mesh resolution ///////////////////////
		...
		*/
		public void freezeToMesh(int meshDetail, float smoothAngle = 100.0f, bool freeMemory = true){
			...
			if(this.autoRigEnabled){
				...
				this.gameObject.GetComponent<SkinnedMeshRenderer>().sharedMesh = mesh; ////////////////////////////////////////////////////////////////////////////////////// add this mesh to some empty object collision mesh
